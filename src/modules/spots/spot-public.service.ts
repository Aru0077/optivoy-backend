...
export class SpotPublicService {
  ...
  private baseSpotSelects(): string[] {
    return [
      ...
      'COALESCE(spot."entryLatitude", spot."exitLatitude") AS "latitude"',
      'COALESCE(spot."entryLongitude", spot."exitLongitude") AS "longitude"',
      ...
      'spot."queueProfileJson" AS "queueProfileJson"',
      'spot."hasFoodCourt" AS "hasFoodCourt"',
